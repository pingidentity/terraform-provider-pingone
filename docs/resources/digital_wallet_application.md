...
- `application_id` (String) The identifier (UUID) of the PingOne mobile application associated with the digital wallet application.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
