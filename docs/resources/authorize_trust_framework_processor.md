...
- `full_name` (String) A string that specifies a unique name generated by the system for each authorization processor resource. It is the concatenation of names in the processor resource hierarchy.
