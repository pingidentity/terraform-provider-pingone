...
func UnmodifiableDataLossProtectionIfWithSummary(f UnmodifiableDataLossProtectionIfFunc, errorSummary, description, markdownDescription string) planmodifier.Bool {
	return requiresReplaceIfModifier{
		ifFunc:              f,
