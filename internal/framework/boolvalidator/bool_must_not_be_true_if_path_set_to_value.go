...
// MustNotBeTrueIfPathSetToValue creates a validator that prevents a boolean from being true when another attribute matches a value.
// It returns a validator that ensures the current boolean attribute is not true when the specified path attribute
