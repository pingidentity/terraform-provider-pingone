...
// MustBeTrueIfPathSetToValue creates a validator that requires a boolean to be true when another attribute matches a value.
// It returns a validator that ensures the current boolean attribute is true when the specified path attribute
