...
func TestAccForm_FieldDeviceAuthentication(t *testing.T) {
	t.Parallel()
	...
	fullStep := resource.TestStep{
		Config: testAccFormConfig_FieldDeviceAuthenticationFull(resourceName, name),
		Check: resource.ComposeTestCheckFunc(
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.#", "2"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.position.row", "0"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.position.col", "0"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.position.width", "50"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.type", "DEVICE_AUTHENTICATION"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.key", "device-authentication-field"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.label", "[{\"type\":\"paragraph\",\"children\":[{\"text\":\"Choose your authentication device\"}]}]"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.required", "true"),
			...
			resource.TestCheckTypeSetElemNestedAttrs(resourceFullName, "components.fields.0.options.*", map[string]string{
				"type":        "SMS",
				"title":       "SMS",
				"description": "Authenticate using SMS",
	...
	minimalStep := resource.TestStep{
		Config: testAccFormConfig_FieldDeviceAuthenticationMinimal(resourceName, name),
		Check: resource.ComposeTestCheckFunc(
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.#", "2"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.position.row", "0"),
			resource.TestCheckResourceAttr(resourceFullName, "components.fields.0.position.col", "0"),
...
func TestAccForm_BadParameters(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccFormConfig_FieldDeviceAuthenticationInvalidOptionsShape(resourceName, name),
				ExpectError: regexp.MustCompile(`Invalid DaVinci form configuration`),
			},
			// Configure
			{
...
func testAccFormConfig_FieldDeviceAuthenticationFull(resourceName, name string) string {
	return fmt.Sprintf(`
	%[1]s
    ...
    fields = [
      {
        ...
        key      = "device-authentication-field"
        label    = "[{\"type\":\"paragraph\",\"children\":[{\"text\":\"Choose your authentication device\"}]}]"
        required = true
...
func testAccFormConfig_FieldDeviceAuthenticationMinimal(resourceName, name string) string {
	return fmt.Sprintf(`
	%[1]s
...
func testAccFormConfig_FieldDeviceAuthenticationInvalidOptionsShape(resourceName, name string) string {
	return fmt.Sprintf(`
	%[1]s
