...
func (r *TrustFrameworkServiceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	trustFrameworkService, d := plan.expand(ctx)
...
func (p *trustFrameworkServiceResourceModel) expand(ctx context.Context) (*authorize.AuthorizeEditorDataDefinitionsServiceDefinitionDTO, diag.Diagnostics) {
...
func (p *trustFrameworkServiceResourceModel) expandCommon(ctx context.Context) (*authorize.AuthorizeEditorDataDefinitionsServiceDefinitionDTOCommon, diag.Diagnostics) {
