...
func combiningAlgorithmObjectSchemaAttributes() (attributes map[string]schema.Attribute) {
	...
	).AllowedValuesEnum(authorizeeditor.AllowedEnumAuthorizeEditorDataPoliciesCombiningAlgorithmDTOAlgorithmEnumValues)
	...
	attributes = map[string]schema.Attribute{
		"algorithm": schema.StringAttribute{
			...
			Validators: []validator.String{
				stringvalidator.OneOf(utils.EnumSliceToStringSlice(authorizeeditor.AllowedEnumAuthorizeEditorDataPoliciesCombiningAlgorithmDTOAlgorithmEnumValues)...),
			},
		},
	}
...
func (p *policyManagementPolicyCombiningAlgorithmResourceModel) expand() *authorizeeditor.AuthorizeEditorDataPoliciesCombiningAlgorithmDTO {

	data := authorizeeditor.NewAuthorizeEditorDataPoliciesCombiningAlgorithmDTO(
		authorizeeditor.EnumAuthorizeEditorDataPoliciesCombiningAlgorithmDTOAlgorithm(p.Algorithm.ValueString()),
	)

	return data
}

func policyManagementPolicyCombiningAlgorithmOkToTF(apiObject *authorizeeditor.AuthorizeEditorDataPoliciesCombiningAlgorithmDTO, ok bool) (basetypes.ObjectValue, diag.Diagnostics) {
