...
func (r *TrustFrameworkAttributeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	trustFrameworkAttribute, d := plan.expand(ctx)
...
func (p *trustFrameworkAttributeResourceModel) expand(ctx context.Context) (*authorize.AuthorizeEditorDataDefinitionsAttributeDefinitionDTO, diag.Diagnostics) {
