...
func TestAccTrustFrameworkProcessor_RemovalDrift(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				PreConfig: func() {
					authorize.TrustFrameworkProcessor_RemovalDrift_PreConfig(ctx, p1Client.API.BetaAPIClients.AuthorizeEditorAPIClient, t, environmentID, processorID)
				},
				RefreshState:       true,
...
func TestAccTrustFrameworkProcessor_Full(t *testing.T) {
	...
	fullCheck := resource.ComposeTestCheckFunc(
		...
		resource.TestCheckResourceAttr(resourceFullName, "description", "Test processor full"),
