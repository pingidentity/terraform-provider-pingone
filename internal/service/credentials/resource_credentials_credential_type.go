...
type CredentialTypeResourceModel struct {
	...
	Description        types.String `tfsdk:"description"` // confirm if same as metadata description
...
type MetadataModel struct {
	...
	Version          types.Int64  `tfsdk:"version"` // fix this in openapi spec - schema is supposed to be string
