...
`
	...
	fullStep := resource.TestStep{
		...
		Check: resource.ComposeTestCheckFunc(
			...
			resource.TestMatchResourceAttr(resourceFullName, "version.id", verify.P1ResourceIDRegexpFullString),
			resource.TestMatchResourceAttr(resourceFullName, "version.number", regexp.MustCompile(`^\d+$`)),
			resource.TestMatchResourceAttr(resourceFullName, "version.uri", verify.IsURLWithHTTPS),
