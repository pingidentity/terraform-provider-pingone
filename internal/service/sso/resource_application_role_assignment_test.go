...
func TestAccRoleAssignmentApplication_Application(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccRoleAssignmentApplicationConfig_Application(resourceName, name, "Application Owner"),
				Check:  successCheck,
			},
			...
			{
				Config:      testAccRoleAssignmentApplicationConfig_Application(resourceName, name, "Identity Data Admin"),
				ExpectError: regexp.MustCompile(`Incompatible role and scope combination`),
			},
			{
				Config:      testAccRoleAssignmentApplicationConfig_Application(resourceName, name, "Environment Admin"),
				ExpectError: regexp.MustCompile(`Incompatible role and scope combination`),
			},
			{
				Config:      testAccRoleAssignmentApplicationConfig_Application(resourceName, name, "Organization Admin"),
				ExpectError: regexp.MustCompile(`Incompatible role and scope combination`),
			},
		},
	})
...
func TestAccRoleAssignmentApplication_Population(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccRoleAssignmentApplicationConfig_Population(resourceName, name, "Application Owner"),
				ExpectError: regexp.MustCompile(`Incompatible role and scope combination`),
			},
			{
...
func TestAccRoleAssignmentApplication_Organisation(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccRoleAssignmentApplicationConfig_Organisation(resourceName, name, "Application Owner", organisationID),
				ExpectError: regexp.MustCompile(`Incompatible role and scope combination`),
			},
			{
...
func TestAccRoleAssignmentApplication_Environment(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccRoleAssignmentApplicationConfig_Environment(resourceName, name, "Application Owner"),
				Check:  successCheck,
			},
			{
...
}`, acctestlegacysdk.MinimalSandboxEnvironment(environmentName, licenseID), environmentName, resourceName, name, roleName)
}

func testAccRoleAssignmentApplicationConfig_Application(resourceName, name, roleName string) string {
	return fmt.Sprintf(`
		%[1]s
...
resource "pingone_application" "%[2]s-admin" {
  environment_id = data.pingone_environment.general_test.id
  name           = "%[3]s admin"
  enabled        = true
...
resource "pingone_application_role_assignment" "%[2]s" {
  environment_id = data.pingone_environment.general_test.id
  application_id = pingone_application.%[2]s-admin.id
...
}`, acctestlegacysdk.MinimalSandboxEnvironment(environmentName, licenseID), environmentName, resourceName, roleName)
}
