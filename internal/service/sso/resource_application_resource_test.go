	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Test removal of the resource
			{
				...
				Check:  sso.ApplicationResource_GetIDs(resourceFullName, &environmentID, &customResourceID, &resourceAttributeID),
			},
			{
				PreConfig: func() {
					sso.ApplicationResource_RemovalDrift_PreConfig(ctx, p1Client.API.ManagementAPIClient, t, environmentID, customResourceID, resourceAttributeID)
				},
				RefreshState:       true,
