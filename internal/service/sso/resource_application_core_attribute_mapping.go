...
// Types
type ApplicationCoreAttributeMappingResource struct {
	client *management.APIClient
	region model.RegionMapping
}

type ApplicationCoreAttributeMappingResourceModel struct {
...
var (
	_ resource.Resource                = &ApplicationCoreAttributeMappingResource{}
	_ resource.ResourceWithConfigure   = &ApplicationCoreAttributeMappingResource{}
	_ resource.ResourceWithImportState = &ApplicationCoreAttributeMappingResource{}
)

// New Object
func NewApplicationCoreAttributeMappingResource() resource.Resource {
	return &ApplicationCoreAttributeMappingResource{}
}
...
// Metadata
func (r *ApplicationCoreAttributeMappingResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_application_core_attribute_mapping"
}

// Schema.
func (r *ApplicationCoreAttributeMappingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	...
	nameDescriptionFmt := "A string that specifies the name of the core attribute. For SAML applications, the core attribute name is `saml_subject` and for OpenID Connect applications, the core attribute name is `sub`."
	...
	requiredDescriptionFmt := "A boolean to specify whether a mapping value is required for this attribute. If `true`, a value must be set and a non-empty value must be available in the SAML assertion or ID token."
	...
	oidcIdTokenEnabledDescriptionFmt := "Whether the attribute mapping should be available in the ID Token. This property is applicable only when the application's `protocol` property is `OPENID_CONNECT`."
	...
	oidcuserinfoEnabledDescriptionFmt := "Whether the attribute mapping should be available through the `/as/userinfo` endpoint. This property is applicable only when the application's protocol property is `OPENID_CONNECT`."
	...
	resp.Schema = schema.Schema{
		...
		Description: "Resource to create and manage a core attribute mapping for applications configured in PingOne.  Core attribute examples are the `sub` claim attribute mapping for OpenID Connect applications, and the `saml_subject` claim attribute mapping for SAML applications.",

		Attributes: map[string]schema.Attribute{
			"id": framework.Attr_ID(),

			"environment_id": framework.Attr_LinkID(framework.SchemaDescription{
				Description: "The ID of the environment to update the application core attribute mapping in."},
			),

			"application_id": framework.Attr_LinkID(framework.SchemaDescription{
				Description: "The ID of the application to update the core attribute mapping for."},
			),
...
func (r *ApplicationCoreAttributeMappingResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ApplicationCoreAttributeMappingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan, state ApplicationCoreAttributeMappingResourceModel
...
func (r *ApplicationCoreAttributeMappingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ApplicationCoreAttributeMappingResourceModel
...
func (r *ApplicationCoreAttributeMappingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state ApplicationCoreAttributeMappingResourceModel
...
func (r *ApplicationCoreAttributeMappingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ApplicationCoreAttributeMappingResourceModel
...
func (r *ApplicationCoreAttributeMappingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	splitLength := 3
	...
	if len(attributes) != splitLength {
		resp.Diagnostics.AddError(
			...
			fmt.Sprintf("invalid id (\"%s\") specified, should be in format \"environment_id/application_id/core_attribute_mapping_id\"", req.ID),
		)
		return
	}
...
func (p *ApplicationCoreAttributeMappingResourceModel) getApplicationType(ctx context.Context, apiClient *management.APIClient) (*management.EnumApplicationProtocol, diag.Diagnostics) {
...
func (p *ApplicationCoreAttributeMappingResourceModel) validate(applicationType *management.EnumApplicationProtocol, isCoreAttribute bool) diag.Diagnostics {
	var diags diag.Diagnostics

	// Check this is a core attribute
	if !isCoreAttribute {
		diags.AddError(
			"Invalid parameter value - Not a core attribute",
			fmt.Sprintf("The attribute name provided (%s) is not a core attribute for application type `%s`.  Use the `pingone_application_attribute_mapping` resource for non-core attribute mappings.", p.Name.ValueString(), string(*applicationType)),
		)
		return diags
	}
	...
	if *applicationType != management.ENUMAPPLICATIONPROTOCOL_OPENID_CONNECT && *applicationType != management.ENUMAPPLICATIONPROTOCOL_SAML {
...
func (p *ApplicationCoreAttributeMappingResourceModel) toState(apiObject *management.ApplicationAttributeMapping) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if p.SAMLSubjectNameformat.Equal(types.StringValue("")) {
		p.SAMLSubjectNameformat = types.StringNull()
	}
