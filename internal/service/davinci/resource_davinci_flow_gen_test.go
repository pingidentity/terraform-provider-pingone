	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config: davinciFlow_DeviceManagementMainFlowHCL(resourceName, withBootstrap),
...
func davinciFlow_DeviceManagementMainFlowHCL(resourceName string, withBootstrap bool) string {
	return fmt.Sprintf(`
		%[1]s
