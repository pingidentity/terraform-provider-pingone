		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					davinciApplicationKey_checkExpectedKeys(t, resourceName, true),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					davinciApplicationKey_checkExpectedKeys(t, resourceName, false),
					davinciApplicationKey_CheckComputedValues(resourceName),
					davinciApplicationKey_GetApplicationApiKey(resourceFullName, &currentApiKey),
				),
			},
...
func davinciApplicationKey_checkExpectedKeys(t *testing.T, resourceName string, expectRotation bool) resource.TestCheckFunc {
	return func(s *terraform.State) error {
