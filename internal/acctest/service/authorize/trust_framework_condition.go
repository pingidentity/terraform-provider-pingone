...
func TrustFrameworkCondition_RemovalDrift_PreConfig(ctx context.Context, apiClient *authorizeeditor.APIClient, t *testing.T, environmentID, trustFrameworkConditionID string) {
