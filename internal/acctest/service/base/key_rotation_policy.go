...
func KeyRotationPolicy_CheckDestroy(s *terraform.State) error {
...
func KeyRotationPolicy_GetIDs(resourceName string, environmentID, resourceID *string) resource.TestCheckFunc {
