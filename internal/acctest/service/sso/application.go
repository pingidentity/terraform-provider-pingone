...
func Application_CheckDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, r, err := apiClient.ApplicationsApi.ReadOneApplication(ctx, rs.Primary.Attributes["environment_id"], rs.Primary.ID).Execute()
...
func Application_GetIDs(resourceName string, environmentID, resourceID *string) resource.TestCheckFunc {
