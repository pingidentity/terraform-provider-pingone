...
func Resource_CheckDestroy(s *terraform.State) error {
...
func Resource_GetIDs(resourceName string, environmentID, resourceID *string) resource.TestCheckFunc {
...
func Resource_RemovalDrift_PreConfig(ctx context.Context, apiClient *management.APIClient, t *testing.T, environmentID, resourceID string) {
