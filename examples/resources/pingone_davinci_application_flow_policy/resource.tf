...
resource "pingone_davinci_application_flow_policy" "my_awesome_registration_flow_application_policy" {
  ...
  # When destroying a pingone_davinci_flow resource and updating a pingone_davinci_application_flow_policy resource 
  # that previously referenced that flow in the same apply, you will need to set lifecycle.create_before_destroy to true.
