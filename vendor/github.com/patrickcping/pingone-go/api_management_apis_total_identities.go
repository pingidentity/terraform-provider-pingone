...
func (r ApiV1EnvironmentsEnvIDTotalIdentitiesGetRequest) Filter(filter string) ApiV1EnvironmentsEnvIDTotalIdentitiesGetRequest {
	r.filter = &filter
	return r
}
...
/*
V1EnvironmentsEnvIDTotalIdentitiesGet READ Total Identity Counts
