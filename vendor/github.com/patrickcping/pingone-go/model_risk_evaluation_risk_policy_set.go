...
func NewRiskEvaluationRiskPolicySet() *RiskEvaluationRiskPolicySet {
	this := RiskEvaluationRiskPolicySet{}
	return &this
}
...
type NullableRiskEvaluationRiskPolicySet struct {
	value *RiskEvaluationRiskPolicySet
	isSet bool
}

func (v NullableRiskEvaluationRiskPolicySet) Get() *RiskEvaluationRiskPolicySet {
	return v.value
}

func (v *NullableRiskEvaluationRiskPolicySet) Set(val *RiskEvaluationRiskPolicySet) {
	v.value = val
	v.isSet = true
}

func (v NullableRiskEvaluationRiskPolicySet) IsSet() bool {
	return v.isSet
}

func (v *NullableRiskEvaluationRiskPolicySet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRiskEvaluationRiskPolicySet(val *RiskEvaluationRiskPolicySet) *NullableRiskEvaluationRiskPolicySet {
	return &NullableRiskEvaluationRiskPolicySet{value: val, isSet: true}
}
